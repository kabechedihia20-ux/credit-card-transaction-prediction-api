...
const Transaction = sequelize.define("Transaction", {
  ...
  dateTransaction: { type: DataTypes.DATE, allowNull: false, field: "date_transaction" },
  paysTransaction: { type: DataTypes.STRING(50), allowNull: false, field: "pays_transaction" },
  statut: { type: DataTypes.STRING(30), allowNull: false, field: "statut" } // ex: "APPROUVEE", "REFUSEE", "EN_ATTENTE"
}, {
